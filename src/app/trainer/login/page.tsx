  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-soft-bg px-6">
      <div className="w-full max-w-md rounded-3xl bg-white p-8 shadow-xl">
        ...
        <h1 className="text-center text-2xl font-black">Trainer Login</h1>
        <p className="mt-2 text-center text-sm text-muted">Fitdog Academy certified trainers only.</p>
        ...
        <form onSubmit={onSubmit} className="mt-8 space-y-4">
          ...
          >
            {busy ? "Signing in..." : "Trainer Sign In"}
          </button>
        </form>
