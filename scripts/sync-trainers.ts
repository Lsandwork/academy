/**
 * Upsert certified trainer profiles without touching users or auth.
 * Run: DATABASE_URL="..." npx tsx scripts/sync-trainers.ts
 */
...
async function main() {
  ...
  for (const trainer of trainers) {
    ...
    console.log(`Synced trainer: ${trainer.name}`);
  }
